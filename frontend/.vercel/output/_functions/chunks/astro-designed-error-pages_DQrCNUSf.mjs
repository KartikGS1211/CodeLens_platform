...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "PUBLIC_API_BASE_URL": "http://localhost:5000", "SITE": undefined, "SSR": true};
